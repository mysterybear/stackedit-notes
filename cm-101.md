...
To finish, here is an example of importing the well-known Material Design color palette, iterating over the colors, and then rendering as many 10x10 div's, setting each one's background color as a color from the palette:
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExODk1MzA0LDIwNzQ0MTUwOSwxNTY0OD
Q3MDcsMTU5OTM0MzI5Nyw3MTE4NzUwOTZdfQ==
-->