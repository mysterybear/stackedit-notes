...
To finish, here is an example which

1. iterates over the Material Design color palette
2. grabs the "400" color (as each color has a range [like this]([https://shuheikagawa.com/material-colors/](https://shuheikagawa.com/material-colors/))) and then rendering as many 100x100px div's, setting each one's background color as a color from the palette:
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5MjAyOTY5MDIsLTExODk1MzA0LDIwNz
